...
public class ClassInfoDAO {
    ...
    public ArrayList<ClassInfo> QueryClassInfoInfo(String classNo,String className,String bornDate,String mainTeacher,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	...
    	if(!mainTeacher.equals("")) hql = hql + " and classInfo.mainTeacher like '%" + mainTeacher + "%'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<ClassInfo> QueryClassInfoInfo(String classNo,String className,String bornDate,String mainTeacher) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From ClassInfo classInfo where 1=1";
    	if(!classNo.equals("")) hql = hql + " and classInfo.classNo like '%" + classNo + "%'";
    	if(!className.equals("")) hql = hql + " and classInfo.className like '%" + className + "%'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String classNo,String className,String bornDate,String mainTeacher) {
        Session s = factory.getCurrentSession();
        String hql = "From ClassInfo classInfo where 1=1";
        if(!classNo.equals("")) hql = hql + " and classInfo.classNo like '%" + classNo + "%'";
        if(!className.equals("")) hql = hql + " and classInfo.className like '%" + className + "%'";
