...
public class CourseDAO {
    ...
    public ArrayList<Course> QueryCourseInfo(String courseNo,ClassInfo classObj,String courseName,Teacher teacherObj,int currentPage) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Course course where 1=1";
    	if(!courseNo.equals("")) hql = hql + " and course.courseNo like '%" + courseNo + "%'";
    	if(null != classObj && !classObj.getClassNo().equals("")) hql += " and course.classObj.classNo='" + classObj.getClassNo() + "'";
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Course> QueryCourseInfo(String courseNo,ClassInfo classObj,String courseName,Teacher teacherObj) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Course course where 1=1";
    	if(!courseNo.equals("")) hql = hql + " and course.courseNo like '%" + courseNo + "%'";
    	if(null != classObj && !classObj.getClassNo().equals("")) hql += " and course.classObj.classNo='" + classObj.getClassNo() + "'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String courseNo,ClassInfo classObj,String courseName,Teacher teacherObj) {
        Session s = factory.getCurrentSession();
        String hql = "From Course course where 1=1";
        if(!courseNo.equals("")) hql = hql + " and course.courseNo like '%" + courseNo + "%'";
        if(null != classObj && !classObj.getClassNo().equals("")) hql += " and course.classObj.classNo='" + classObj.getClassNo() + "'";
