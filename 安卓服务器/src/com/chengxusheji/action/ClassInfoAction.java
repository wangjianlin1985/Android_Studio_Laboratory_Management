...
public class ClassInfoAction extends BaseAction {
    ...
    public String QueryClassInfo() {
        ...
        List<ClassInfo> classInfoList = classInfoDAO.QueryClassInfoInfo(classNo, className, bornDate, mainTeacher, currentPage);
        /*计算总的页数和总的记录数*/
        classInfoDAO.CalculateTotalPageAndRecordNumber(classNo, className, bornDate, mainTeacher);
        /*获取到总的页码数目*/
        ...
        ctx.put("mainTeacher", mainTeacher);
        return "query_view";
    }
    ...
    public String QueryClassInfoOutputToExcel() { 
        ...
        if(bornDate == null) bornDate = "";
        if(mainTeacher == null) mainTeacher = "";
        List<ClassInfo> classInfoList = classInfoDAO.QueryClassInfoInfo(classNo,className,bornDate,mainTeacher);
