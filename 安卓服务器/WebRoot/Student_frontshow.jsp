...
<table width='100%' cellspacing='1' cellpadding='3'  class="tablewidth">
  ...
  <tr>
    <td width=30%>所在班级:</td>
    <td width=70%>
      <%=student.getClassObj().getClassName() %>
    </td>
  </tr>
  ...
  <tr>
    <td width=30%>性别:</td>
    <td width=70%><%=student.getGender() %></td>
  </tr>

  <tr>
    <td width=30%>出生日期:</td>
        <% java.text.DateFormat birthDateSDF = new java.text.SimpleDateFormat("yyyy-MM-dd");  %>
    <td width=70%><%=birthDateSDF.format(student.getBirthDate()) %></td>
  </tr>
  ...
  <tr>
    <td width=30%>邮箱:</td>
    <td width=70%><%=student.getEmail() %></td>
  </tr>
