...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>学号:</td>
    <td width=70%><input id="student.studentNo" name="student.studentNo" type="text" /></td>
  </tr>

  <tr>
    <td width=30%>登录密码:</td>
    <td width=70%><input id="student.password" name="student.password" type="text" size="30" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>性别:</td>
    <td width=70%><input id="student.gender" name="student.gender" type="text" size="4" /></td>
  </tr>

  <tr>
    <td width=30%>出生日期:</td>
    <td width=70%><input type="text" readonly id="student.birthDate"  name="student.birthDate" onclick="setDay(this);"/></td>
  </tr>
  ...
  <tr>
    <td width=30%>邮箱:</td>
    <td width=70%><input id="student.email" name="student.email" type="text" size="50" /></td>
  </tr>
