...
public class CourseTeacherListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(CourseTeacherListActivity.this, CourseQueryActivity.class);
		...
		title.setText("我的实验课程列表");
		ImageView add_btn = (ImageView) this.findViewById(R.id.add_btn);
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(CourseTeacherListActivity.this, CourseAddActivity.class);
				startActivityForResult(intent,ActivityUtils.ADD_CODE);
			}
		});
		add_btn.setVisibility(View.GONE);
		
		queryConditionCourse = new Course();
		queryConditionCourse.setCourseNo("");
		queryConditionCourse.setClassObj("");
		queryConditionCourse.setCourseName("");
		queryConditionCourse.setTeacherObj(username);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new CourseSimpleAdapter(CourseTeacherListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(CourseTeacherListActivity.this, CourseDetailActivity.class);
	...
	private OnCreateContextMenuListener courseListItemListener = new OnCreateContextMenuListener() {
		public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
			//menu.add(0, 0, 0, "编辑实验课程信息"); 
			//menu.add(0, 1, 0, "删除实验课程信息");
		}
	};
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑实验课程信息
			...
			Intent intent = new Intent();
			intent.setClass(CourseTeacherListActivity.this, CourseEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putString("courseNo", courseNo);
			intent.putExtras(bundle);
			startActivityForResult(intent,ActivityUtils.EDIT_CODE);
		} else if (item.getItemId() == 1) {// 删除实验课程信息
			ContextMenuInfo info = item.getMenuInfo();
			AdapterContextMenuInfo contextMenuInfo = (AdapterContextMenuInfo) info;
			// 获取选中行位置
			int position = contextMenuInfo.position;
	...
	protected void dialog() {
		Builder builder = new Builder(CourseTeacherListActivity.this);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			/* 查询实验课程信息 */
			List<Course> courseList = courseService.QueryCourse(queryConditionCourse);
