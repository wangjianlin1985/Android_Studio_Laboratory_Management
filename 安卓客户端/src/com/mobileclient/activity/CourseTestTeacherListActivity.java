...
public class CourseTestTeacherListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(CourseTestTeacherListActivity.this, CourseTestQueryActivity.class);
		...
		title.setText("我的课程实验查询列表");
		ImageView add_btn = (ImageView) this.findViewById(R.id.add_btn);
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(CourseTestTeacherListActivity.this, CourseTestAddActivity.class);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new CourseTestSimpleAdapter(CourseTestTeacherListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(CourseTestTeacherListActivity.this, CourseTestDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑课程实验信息
			...
			Intent intent = new Intent();
			intent.setClass(CourseTestTeacherListActivity.this, CourseTestEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("testId", testId);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(CourseTestTeacherListActivity.this);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			/* 查询课程实验信息 */
			Declare declare = (Declare) CourseTestTeacherListActivity.this.getApplication();
			List<CourseTest> courseTestList = courseTestService.teacherQueryCourseTest(declare.getUserName());
