...
public class MoreActivity extends Activity {
	//private String[] strs = new String[]{"学生","老师","实验课程","课程实验","周信息","实验设备","修改个人信息","关于"};
	private String[] strs = new String[]{"老师查询","实验设备查询","修改个人信息","关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(declare.getIdentify().equals("teacher"))
			strs = new String[]{"学生查询","实验设备查询","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				if(declare.getIdentify().equals("student")) {
					// TODO Auto-generated method stub
					if(arg2 == 0){
						Intent intent  = new Intent(MoreActivity.this, TeacherListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 1){
						Intent intent  = new Intent(MoreActivity.this, DeviceListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 2){
						String studentNo = declare.getUserName();
						Intent intent = new Intent();
						intent.setClass(MoreActivity.this, StudentEditActivity.class);
					...
					// TODO Auto-generated method stub
					if(arg2 == 0){
						Intent intent  = new Intent(MoreActivity.this, StudentListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 1){
						Intent intent  = new Intent(MoreActivity.this, DeviceListActivity.class);
					...
					if(arg2 == 2){
						String teacherNo = declare.getUserName();
						Intent intent = new Intent();
						intent.setClass(MoreActivity.this, TeacherEditActivity.class);
						Bundle bundle = new Bundle();
