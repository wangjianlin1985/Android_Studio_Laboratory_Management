...
public class CourseTestStudentListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(CourseTestStudentListActivity.this, CourseTestQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(CourseTestStudentListActivity.this, CourseTestAddActivity.class);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new CourseTestSimpleAdapter(CourseTestStudentListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(CourseTestStudentListActivity.this, CourseTestDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑课程实验信息
			...
			Intent intent = new Intent();
			intent.setClass(CourseTestStudentListActivity.this, CourseTestEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("testId", testId);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(CourseTestStudentListActivity.this);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			/* 查询课程实验信息 */
			Declare declare= (Declare) CourseTestStudentListActivity.this.getApplication();
			List<CourseTest> courseTestList = courseTestService.studentQueryCourseTest(declare.getUserName());
