			...
			public void onClick(View v) {
				try {
					...
					if(ET_stateId.getText().toString().equals("")) {
						Toast.makeText(LatStateAddActivity.this, "状态id输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_stateName.getText().toString().equals("")) {
						Toast.makeText(LatStateAddActivity.this, "状态名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传实验室状态信息*/
					LatStateAddActivity.this.setTitle("正在上传实验室状态信息，稍等...");
