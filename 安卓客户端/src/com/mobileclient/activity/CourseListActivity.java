...
public class CourseListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(CourseListActivity.this, CourseQueryActivity.class);
				startActivityForResult(intent,ActivityUtils.QUERY_CODE);//此处的requestCode应与下面结果处理函中调用的requestCode一致
			}
		});
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("实验课程查询列表");
		ImageView add_btn = (ImageView) this.findViewById(R.id.add_btn);
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(CourseListActivity.this, CourseAddActivity.class);
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new CourseSimpleAdapter(CourseListActivity.this, list,
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑实验课程信息
			...
			Intent intent = new Intent();
			intent.setClass(CourseListActivity.this, CourseEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putString("courseNo", courseNo);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(CourseListActivity.this);
